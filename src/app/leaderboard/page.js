...
export default function Dashboard() {
  ...
  // 🟢 UPDATED: Added 'users' to stats state
  ...
  useEffect(() => {
    ...
    // Load Data
    loadSessions(p);
    loadGlobalStats(p); // 🟢 Load the User Count
  ...
  // --- API ACTIONS: STATS ---
  // 🟢 NEW: Fetch Total Users from Backend
  ...
  const resetSession = async (id) => {
    ...
    loadSessions();
    loadGlobalStats(); // Refresh user count
  };
    ...
    <div className="layout">
      ...
      <main className="main-content">
        ...
        <div className="stats-grid">
          {/* Card 1: Total Users (Replaced Sessions) */}
          <div className="stat-card">
            <div className="stat-icon">👥</div>
            {/* Show Total Users from DB */}
